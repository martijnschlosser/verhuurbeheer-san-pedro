export const siteConfig = {
  ...
  seo: {
    ...
    longTailKeywords: [
      ...
      "appartement laten verhuren in San Pedro de Alcántara met beheer",
      "villa laten verhuren in San Pedro de Alcántara met Nederlandstalige beheerder",
      "tweede woning beheren op afstand in San Pedro de Alcántara",
      "sleutelbeheer voor tweede woning in San Pedro de Alcántara",
      "Airbnb en Booking beheer in San Pedro de Alcántara",
      "rendement vakantiewoning in San Pedro de Alcántara",
      "property management in San Pedro de Alcántara voor Nederlandse eigenaren",
      "wat kost verhuurbeheer in San Pedro de Alcántara",
    ],
  },
  analytics: {
    ...
    searchConsoleVerification:
      process.env.NEXT_PUBLIC_GOOGLE_SITE_VERIFICATION ?? "TU5yJ75UMnSAsWp9mw-EIddSgUELEkkqvajQLmWARII",
  },
} as const;
