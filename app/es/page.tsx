...
const faqs = [
  ...
  [
    ...
    "Ayudamos a propietarios en San Pedro de Alcántara Pueblo, Nueva Alcántara, La Cala de San Pedro de Alcántara, Guadalmina, Guadalmina Baja, San Pedro de Alcántara Golf, Marbella west y Puerto Banús. Cada vivienda y ubicación se valora individualmente.",
  ],
  [
    ...
    <main lang="es">
      ...
      <section className="home-team">
        <div className="home-team-copy">
          ...
          <h2>Contacto personal con profesionales que conocen San Pedro de Alcántara.</h2>
          <p>
