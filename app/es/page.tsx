...
const faqs = [
  [
    "¿Cuánto cuesta la gestión de alquiler vacacional en San Pedro de Alcántara?",
  ...
  [
    ...
    "Por supuesto. Bloqueamos tus estancias con antelación y adaptamos la estrategia a los periodos en que quieras visitar San Pedro de Alcántara.",
  ],
  [
  ...
  [
    "¿En qué zonas de San Pedro de Alcántara trabajáis?",
    "Ayudamos a propietarios en San Pedro de Alcántara Pueblo, Nueva Alcántara, La Cala de San Pedro de Alcántara, Guadalmina, Guadalmina Baja, San Pedro de Alcántara Golf, Marbella west and Puerto Banús. Cada vivienda y ubicación se valora individualmente.",
  ],
  [
    "¿Necesito licencia turística para alquilar vacacionalmente en San Pedro de Alcántara?",
...
function LocalizedHome() {
  ...
  const schema = {
    ...
    description:
      "Gestión integral de propiedades, alquiler vacacional y cuidado de segundas residencias para propietarios en San Pedro de Alcántara.",
    parentOrganization: {
      "@type": "Organization",
    ...
    knowsAbout: [
      "Gestión de propiedades San Pedro de Alcántara",
    ...
    <main lang="es">
      ...
      <header classNombre="site-header">
        <a
          ...
          href="/"
          aria-label="Gestión de propiedades San Pedro de Alcántara – Home"
        >
          <img
            src="/terras-zonsondergang-san-pedro.webp"
            alt="Gestión de propiedades San Pedro de Alcántara logo"
            width="54"
            height="54"
          />
        </a>
      ...
      <section classNombre="hero" id="top">
        ...
        <div classNombre="hero-inner">
          ...
          <p>
            Desde Nueva Alcántara and La Cala to San Pedro de Alcántara Pueblo, combinamos una gestión inteligente con profesionales locales de confianza. Tienes un único contactoo para reservas, huéspedes, limpieza, mantenimiento y cuidado diario de la vivienda.
          </p>
        ...
        <div classNombre="hero-stats">
          ...
          <span>
            <CheckCircle2 aria-hidden="true" />
            <b>Servicio local</b> in San Pedro de Alcántara y alrededores
          </span>
        </div>
      </section>
      ...
      <section
        ...
        aria-label="Viviendas y propiedades en San Pedro de Alcántara"
      >
        <figure classNombre="showcase-wide">
          <img
            src="/villa-zwembad-san-pedro.webp"
            alt="Villa moderna en San Pedro de Alcántara con terraza, piscina y vistas al mar"
            width="1536"
            height="1024"
            loading="eager"
          />
        ...
        <figure>
          <img
            src="/terras-zonsondergang-san-pedro.webp"
            alt="Vivienda vacacional en la costa de San Pedro de Alcántara"
            width="1800"
            height="1118"
            loading="lazy"
          />
        ...
        <figure>
          <img
            ...
            alt="Vivienda vacacional de lujo en San Pedro de Alcántara con vistas al mar"
            width="1600"
            height="1200"
            loading="lazy"
          />
      ...
      <section classNombre="regions compact-regions" id="regios">
        <div classNombre="section-head">
          ...
          <p>
            Desdeal apartments and golf townhouses to hillside villas, we work throughout San Pedro de Alcántara Pueblo, La Cala de San Pedro de Alcántara, Nueva Alcántara, Guadalmina, Puerto Banús, Guadalmina Baja and San Pedro de Alcántara Golf.
          </p>
        </div>
        <div classNombre="area-list" aria-label="Zonas atendidas alrededor de San Pedro de Alcántara">
      ...
      <section classNombre="home-team">
        <div classNombre="home-team-copy">
          ...
          <h2>Personal contacto with people who know San Pedro de Alcántara.</h2>
          <p>
      ...
      <section classNombre="knowledge compact-knowledge" id="kennisbank">
        <div classNombre="section-head">
          ...
          <p>
            Información clara sobre costes, estrategia de alquiler, normativa y gestión de propiedades en San Pedro de Alcántara.
          </p>
        </div>
      ...
      <section classNombre="faq">
        <div>
          ...
          <p>
            Preguntas clave sobre nuestros servicios y tarifas en San Pedro de Alcántara.
          </p>
        </div>
        <div>
          {homeFaqs.map(([q, a], i) => (
      ...
      <footer classNombre="site-footer">
        <div classNombre="footer-brand">
          <a classNombre="logo-lockup" href="/" aria-label="Home">
            <img
              src="/terras-zonsondergang-san-pedro.webp"
              alt="Gestión de propiedades San Pedro de Alcántara"
              width={640}
              height={640}
              sizes="54px"
            />
          ...
          <p>
            Gestión de propiedades San Pedro de Alcántara forma parte de{" "}
